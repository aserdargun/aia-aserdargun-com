...
export const plans = [
  ...
  },
  {
    ...
    billingNote: "M3 standard prices depend on input length; priority service costs 1.5x standard.",
    highlights: [
  ...
  },
  {
    ...
    billingNote: "Four tiers: Lite, Essential, Standard, Pro. Seven-day credit limits apply; promotional prices differ from list prices.",
  ...
  },
  {
    ...
    priceDisplay: "Historical offer — current terms unverified",
    billingNote: "The former Coding Plan URL now redirects to Token Plan. The earlier $50 price and request quotas cannot be reconfirmed there.",
    highlights: ["Review current Token Plan terms before choosing a subscription"],
